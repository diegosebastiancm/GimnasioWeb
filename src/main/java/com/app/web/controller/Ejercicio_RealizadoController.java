...
public class Ejercicio_RealizadoController {
	...
	public String guardarEjercicioRealizado(@ModelAttribute("ejercicioRealizado") Ejercicio_Realizado ejercicioRealizado) {
	...
	/*
	 * @PostMapping("/ejercicioRealizado/{id}") public String
	 * actualizarEjercicioRealizado(@PathVariable Integer
	 * id,@ModelAttribute("ejercicio_Realizado") Ejercicio_Realizado
	 * ejercicio_Realizado, Model modelo) { Ejercicio_Realizado
	 * ejercicioRealizadoExistente =
	 * ejercicio_RealizadoRepository.findById(id).get();
	 * ejercicioRealizadoExistente.setPeso_levantado(ejercicio_Realizado.
	 * getPeso_levantado());
	 * ejercicioRealizadoExistente.setRepeticiones_realizadas(ejercicio_Realizado.
	 * getRepeticiones_realizadas());
	 * ejercicioRealizadoExistente.setSeries_realizadas(ejercicio_Realizado.
	 * getSeries_realizadas());
	 * ejercicio_RealizadoRepository.save(ejercicioRealizadoExistente); return
	 * "redirect:/ejerciciosRealizados"; //path de luisa }
	 */
